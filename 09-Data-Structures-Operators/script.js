...
const calcmin = function (totalTime) {
  // console.log(gameEvents.size);
  return totalTime / gameEvents.size;
};

console.log(calcmin(90));
...
let averageOdds = sum / Object.keys(game.odds).length;
console.log(sum);
...
console.log(printGoals('Lewandowski', 'Gotze'));
